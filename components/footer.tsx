...
export function Footer() {
  ...
  return (
    <footer className="relative bg-slate-950 text-slate-200 border-t border-slate-900 pt-16 pb-12 px-6">
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 pb-12 border-b border-slate-900">
          ...
          <div className="md:col-span-2 space-y-4">
            ...
            <div className="flex gap-4 pt-2">
              <a
                ...
                className="p-2.5 bg-slate-900 border border-slate-800 rounded-lg hover:bg-blue-600 hover:border-blue-600 hover:text-white transition-all duration-200"
                aria-label="GitHub"
              >
                <Github size={18} />
              </a>
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-300 uppercase tracking-widest mb-4">Navigation</h4>
          ...
          {/* Focus Areas Column */}
          <div>
            <h4 className="text-xs font-bold text-slate-300 uppercase tracking-widest mb-4">Focus Areas</h4>
        ...
        <div className="pt-8 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <button
            ...
            className="group inline-flex items-center gap-2 px-4 py-2 bg-slate-900 hover:bg-slate-850 text-slate-400 hover:text-white border border-slate-800 rounded-lg text-xs font-medium transition-all duration-200 shadow-md"
          >
            Back to top 
