...
const projects = [
  ...
  },
  {
    ...
    features: [
      ...
      "Push notifications integration via OneSignal",
  ...
  },
  {
    ...
    features: [
      ...
      "Push and in-app notifications via Firebase Cloud Messaging (FCM)",
      ...
      <div className="max-w-6xl mx-auto">
        <div className="mb-12">
          ...
          <p className="text-xl text-slate-600 mt-6 max-w-3xl">
            Production-ready applications that showcase my expertise in React
            Native development and real-world problem solving.
          </p>
        </div>
        ...
        <div className="space-y-10">
          {projects.map((project, index) => (
            <article
              key={project.title}
              className="group bg-white border-2 border-slate-200 rounded-2xl overflow-hidden hover:border-blue-400 hover:shadow-2xl transition-all duration-300"
            >
              <div className="grid md:grid-cols-3 gap-0 h-full">
                ...
                <div className="md:col-span-2 p-10 flex flex-col justify-between">
                  <div>
                    ...
                    {/* Tech Stack */}
                    <div className="mb-8">
                      <p className="text-sm font-bold text-slate-900 mb-3 uppercase tracking-widest">
                        Tech Stack
                      </p>
